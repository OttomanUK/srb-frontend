          ...
          <ul>
            <li className="border-b border-slate-200 dark:border-slate-700 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣 <span className="font-medium text-slate-800 dark:text-slate-100">Detected Anomalies Recently</span> Check the dashboard</span>
                <span className="block text-xs font-medium text-slate-400 dark:text-slate-500">Feb 10, 2024</span>
              </Link>
            </li>
            <li className="border-b border-slate-200 dark:border-slate-700 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣 <span className="font-medium text-slate-800 dark:text-slate-100">Security Alert</span>Your password may have been breached</span>
                <span className="block text-xs font-medium text-slate-400 dark:text-slate-500">Feb 10, 2024</span>
              </Link>
            </li>
            <li className="border-b border-slate-200 dark:border-slate-700 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣<span className="font-medium text-slate-800 dark:text-slate-100">Your progress has been good</span> Make sure to go through analytics </span>
                <span className="block text-xs font-medium text-slate-400 dark:text-slate-500">Feb 10, 2024</span>
              </Link>
            </li>
          </ul>
