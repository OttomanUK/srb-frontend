          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={(e) => {
                ...
                navigate(
                  `/Missing?&ntn=${e.target.value}&pos_id=${pos_id}&page=${page}&date=${date}&location=${location}`
                );
              }}
            ...
            >
              {allNtn.map((ntn, index) => (
                <option
                  key={index}
                  value={ntn}
                  className="rounded  font-bold italic bg-grey-300 text-grey-100 hover:bg-darkblue  border border-grey-500 border-solid"
                >
                  {ntn}
                </option>
              ))}
